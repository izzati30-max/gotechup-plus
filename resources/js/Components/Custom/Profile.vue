...
<template>
    <section class="relative pt-36 pb-24">
        <div class="bg-gradient-to-br from-black to-[#FDD201] w-full absolute top-0 left-0 z-0 h-60 object-cover"></div>
        ...
        <div class="w-full max-w-7xl mx-auto px-6 md:px-8">
            <div class="flex items-center justify-center relative z-10 mb-2.5">
                <div class=" w-36 h-36 bg-gradient-to-br from-black to-[#FDD201] mt-10 rounded-full flex items-center justify-center text-3xl font-bold text-white border-4 border-white bg-black dark:border-gray-800 shadow-xl mb-4">
                    {{ initials }}
                </div>
            ...
            <p class="font-normal text-base leading-7 text-gray-500 text-center mb-8">Company ABC</p>
